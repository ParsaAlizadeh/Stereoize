...
infiles = [mypath+f for f in listdir(mypath) if isfile(join(mypath, f)) and f.find(".wav") != -1]

W = 500
zoom = 100
running = True
disp = pygame.display.set_mode((W, W))
skiptxt = getFont(32).render("Press Space to skip this file", True, (255,255,255))
...
while running:
    ...
    disp.blit(skiptxt, ((W - skiptxt.get_width())/ 2, W-30))
